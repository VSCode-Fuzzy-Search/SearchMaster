/**
 * @file exploratory.test.ts
 * @fileoverview This file contains the test suite for exploratory testing of the extension.
 *               Testing is powered by the Chai assertion library.
 * @see {@link https://martinfowler.com/articles/practical-test-pyramid.html#ExploratoryTesting}
